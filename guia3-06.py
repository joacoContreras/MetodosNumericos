...
# Ejemplo de uso:
A = np.array([[-1,1,-1/math.sqrt(2),0,0,0],[0,0,1/math.sqrt(2),1,0,0],[0,-1,0,0,-1/math.sqrt(2),0],
[0,0,0,0,1/math.sqrt(2),0],[0,0,0,0,1/math.sqrt(2),-1],[0,0,0,-1,-1/math.sqrt(2),0]])
