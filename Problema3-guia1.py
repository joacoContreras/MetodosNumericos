...
grav = 9.81  # m/s^2 (aceleración debida a la gravedad)
c = 14  # kg/s (coeficiente de resistencia del aire)
v = 35  # m/s (velocidad deseada)
t = 7   # s (tiempo)

# Definición de la función que se quiere encontrar la raíz
def f(m):
    return (grav * m / c) * (1 - math.exp(-(c / m) * t)) - v
...
xl = 50  # Límite inferior de la masa
xu = 150  # Límite superior de la masa
tol = 1e-5
